...
static std::string movielocation = "/Users/irita/Documents/Master/Research/Tracking/Moving Camera - code/Others/TGA-PCA/movie";
...
namespace grassmann_averages_pca
{
  namespace applications
  {
    ...
    void number2filename(size_t file_number, char *filename)
    {
      ...
      sprintf(filename, 
              (movielocation + "/starwars_%.3d/frame%d.jpg").c_str(), 
              dir_num, 
              file_number);
    }
    ...
    public:
      ...
      void signal_mean(const data_t& mean) const
      {
        ...
        save_vector(mean, "../subspaces/mean_vector.txt");
      }
                      ...
                      size_t current_eigenvector_dimension) const
      {
        ...
        save_vector(pca, filename_from_template("../subspaces/vector_pca_%.7d.txt", current_eigenvector_dimension));
      }
                              ...
                              size_t current_eigenvector_dimension) const
      {
        ...
        save_vector(current_eigenvector, filename_from_template("../subspaces/vector_subspace_%.7d.txt", current_eigenvector_dimension));
      }
